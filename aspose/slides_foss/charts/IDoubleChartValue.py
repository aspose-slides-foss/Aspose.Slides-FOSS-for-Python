...
class IDoubleChartValue(ISingleCellChartValue, ABC):
    ...
    def as_literal_double(self) -> float:
        """Returns or sets literal double value if DataSourceType = Charts.DataSourceType.DoubleLiterals. Read/write ."""
        ...
